...
class Employee(object):
    '''Write the constructor below. It should take in five arguments:
       ...
       are required.'''
    def __init__(self, first, last, title, hpw, hr):
    ...
    def set_hourly_rate(self, new_hr):
        self.__hourly_rate = new_hr
...
class Manager(Employee):  
    ...
    def __init__(self, first, last, title, hpw, hr, bonus_percent):
        super().__init__(first, last, title, hpw, hr)
        try:
    ...
    def get_total_compensation(self):
        return (100 + self.bonus_percent)/ 100.0 * super().get_total_compensation() 
