...
if __name__ == "__main__":
    ...
    linkedList1 = create_linked_list([1, 2, 3, 4, 5, 6])
    even_after_odd(linkedList1)
    print_linked_list(linkedList1)

    linkedList2 = create_linked_list([1, 3, 5, 7])
    even_after_odd(linkedList2)
    print_linked_list(linkedList2)

    linkedList3 = create_linked_list([2, 4, 6, 8])  
    even_after_odd(linkedList3)
